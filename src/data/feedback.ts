...
export const FEEDBACK_QUESTIONS: FeedbackQuestion[] = [
  { rowNumber: 3, answerIndex: 0, text: 'Assiduidade ao treino', fullText: 'Como foi sua assiduidade ao treino?', options: GOOD_AVERAGE_BAD },
  { rowNumber: 4, answerIndex: 1, text: 'Desempenho nos treinos', fullText: 'Como foi seu desempenho nos treinos?', options: GOOD_AVERAGE_BAD_MASCULINE },
  { rowNumber: 5, answerIndex: 2, text: 'Recuperacao da semana', fullText: 'Como foi sua recuperação ao longo da semana?', options: GOOD_AVERAGE_BAD },
  { rowNumber: 6, answerIndex: 3, text: 'Exercicio que nao gosta', fullText: 'Tem algum exercício que não goste? (Se sim, descreva nos comentários)', options: YES_NO },
  { rowNumber: 7, answerIndex: 4, text: 'Dificuldade de execucao', fullText: 'Tem algum exercício que esteja com dificuldade de execução? (Se sim, descreva nos comentários)', options: YES_NO },
  { rowNumber: 8, answerIndex: 5, text: 'Exercicio para o proximo bloco', fullText: 'Tem algum exercício que você gostaria de ter no próximo bloco? Pode ser um que já faz ou não. (Se sim, descreva nos comentários)', options: YES_NO },
  { rowNumber: 9, answerIndex: 6, text: 'Tempo de duracao dos treinos', fullText: 'Como está o tempo de duração dos treinos? (Se tiver mais tempo ou estiver longo demais, descreva quanto nos comentários)', options: DURATION_OPTIONS },
  ...
  { rowNumber: 11, answerIndex: 7, text: 'Videos enviados', fullText: 'Você enviou vídeos do treino?', options: YES_NO },
  { rowNumber: 12, answerIndex: 8, text: 'Contato em caso de duvidas', fullText: 'Você manteve contato quando teve dúvidas?', options: YES_NO },
  { rowNumber: 13, answerIndex: 9, text: 'Dor ou desconforto', fullText: 'Você está sentindo alguma dor ou desconforto?', options: YES_NO },
  { rowNumber: 14, answerIndex: 10, text: 'Sono', fullText: 'Como foi o seu sono?', options: GOOD_AVERAGE_BAD_MASCULINE },
  { rowNumber: 15, answerIndex: 11, text: 'Dieta', fullText: 'Como foi a dieta?', options: GOOD_AVERAGE_BAD },
  { rowNumber: 16, answerIndex: 12, text: 'Progressao da semana', fullText: 'Você está satisfeito(a) com a progressão da semana?', options: YES_NO }
];
